...
CREATE TABLE compras (
    ...
    tipo_comprobante VARCHAR(20) NOT NULL CHECK (tipo_comprobante IN ('Factura', 'Boleta', 'Guia de Remision', 'Nota de Credito')),
...
CREATE TABLE ventas (
    ...
    usuario_id INT NOT NULL REFERENCES usuarios(id) ON DELETE RESTRICT,
    tipo_comprobante VARCHAR(20) NOT NULL CHECK (tipo_comprobante IN ('Factura', 'Boleta', 'Guia de Remision', 'Ticket')),
    serie_comprobante VARCHAR(10) NOT NULL,
    correlativo_comprobante VARCHAR(20) NOT NULL,
